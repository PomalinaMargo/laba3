...
public partial class MainPage : ContentPage
{
	...
	private async void ShowInfo(object? _, EventArgs args) {
		await DisplayAlert("Information", "Author: Pomalina Marharyta Serhiivna, 2 course, K-25, 2023\nJsonEditor allows the user to view and edit json files associated with books. There is feature to filter file entries", "Ok");
	}
